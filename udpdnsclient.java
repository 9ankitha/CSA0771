...
{ BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
 ...
 byte[] transferdata = new byte[1024]; byte[] receivedata = new byte[1024];
 int portaddr = 1362; System.out.print("Enter the hostname : "); 
String sentence = br.readLine(); transferdata = sentence.getBytes(); DatagramPacket pack = new DatagramPacket(transferdata,transferdata.length, ipaddress,portaddr); 
